...
xbmcvfs.delete('special://home/userdata/addon_data/plugin.video.sealteam6/providers.13.db')
xbmcvfs.delete('special://home/userdata/addon_data/plugin.video.sealteam6/meta.5.db')
xbmcvfs.delete('special://home/userdata/addon_data/plugin.video.sealteam6/cache.db')

xbmcvfs.delete('special://home/userdata/addon_data/plugin.video.quicksilver/providers.13.db')
xbmcvfs.delete('special://home/userdata/addon_data/plugin.video.quicksilver/meta.5.db')
xbmcvfs.delete('special://home/userdata/addon_data/plugin.video.quicksilver/cache.db')

xbmcvfs.delete('special://home/userdata/addon_data/plugin.video.blacklodge/providers.13.db')
xbmcvfs.delete('special://home/userdata/addon_data/plugin.video.blacklodge/meta.5.db')
xbmcvfs.delete('special://home/userdata/addon_data/plugin.video.blacklodge/cache.db')
...
cacheFile = join(dataPath, 'provider.db')


dataPath_atlas       = transPath('special://home/userdata/addon_data/plugin.video.atlas')
dataPath_homelander  = transPath('special://home/userdata/addon_data/plugin.video.homelander')
dataPath_scrubsv2    = transPath('special://home/userdata/addon_data/plugin.video.scrubsv2')
dataPath_thecrew     = transPath('special://home/userdata/addon_data/plugin.video.thecrew')
dataPath_seren       = transPath('special://home/userdata/addon_data/plugin.video.seren')
dataPath_shadow      = transPath('special://home/userdata/addon_data/plugin.video.shadow')
dataPath_blacklodge  = transPath('special://home/userdata/addon_data/plugin.video.blacklodge')
dataPath_quicksilver = transPath('special://home/userdata/addon_data/plugin.video.quicksilver')

#######################Provider############################

provider_shadow        = join(dataPath_shadow, 'providers.db')
provider_scrubsv2      = join(dataPath_scrubsv2, 'providers.db')
provider_thecrew       = join(dataPath_thecrew, 'providers.13.db')
provider_homelander    = join(dataPath_homelander, 'providers.13.db')
provider_blacklodge    = join(dataPath_blacklodge, 'providers.13.db') ##  World Build ##
provider_quicksilver   = join(dataPath_quicksilver, 'providers.13.db') ##  World Build ##

#######################Meta############################

meta_scrubsv2    = join(dataPath_scrubsv2, 'meta.5.db')
meta_thecrew     = join(dataPath_thecrew, 'meta.5.db')
meta_homelander  = join(dataPath_homelander, 'meta.5.db')
meta_blacklodge  = join(dataPath_blacklodge, 'meta.5.db') ##  World Build ##
meta_quicksilver = join(dataPath_quicksilver, 'meta.5.db') ##  World Build ##

#######################Cache############################

cache_atlas       = join(dataPath_atlas , 'cache.db')
cache_shadow      = join(dataPath_shadow , 'cache.db')
cache_scrubsv2    = join(dataPath_scrubsv2 , 'cache.db')
cache_thecrew     = join(dataPath_thecrew, 'cache.db')
cache_homelander  = join(dataPath_homelander, 'cache.db')
cache_seren       = join(dataPath_seren, 'cache.db')
cache_blacklodge  = join(dataPath_blacklodge, 'cache.db') ##  World Build ##
cache_quicksilver = join(dataPath_quicksilver, 'cache.db') ##  World Build ##
